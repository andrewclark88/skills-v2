...
fetched: 2026-06-15
source_title: A critique of how story points, originally designed as a psychological safety mechanism to decouple…
...
1. A critique of how story points, originally designed as a psychological safety mechanism to decouple estimates from time commitments, become dysfunctional when organizations treat velocity as a performance target or attempt to normalize points across teams.
2. Original purpose: story points emerged as "a psychological safety mechanism to decouple estimates from time-based commitments" — a relative unit meant to support collaborative planning, not cross-team comparison.
3. Goodhart's Law activation: "When a measure becomes a target, it ceases to be a good measure" — once velocity becomes a performance target, teams inflate estimates, split stories to optimize for points rather than value, and cut quality corners to hit targets.
4. Ron Jeffries (cited through, one of the originators): "I may have invented story points, and if I did, I'm sorry now," and he "no longer recommend[s] velocity, which means that I also no longer recommend story estimation in points."
5. Normalizing story points across teams "treats relative estimates as absolute, comparable metrics" — the specific mechanism that produces the Goodhart's Law failure mode.
6. The article provides no support for using story points in automated queue ordering; it argues story points are "fundamentally team-specific and context-dependent" and that extracting them from their social context amplifies the dysfunctions.
