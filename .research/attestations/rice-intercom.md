...
fetched: 2026-06-15
source_title: The canonical introduction of the RICE scoring model by Sean McBride at Intercom. The post defines t…
...
1. The canonical introduction of the RICE scoring model by Sean McBride at Intercom.
2. The post defines the four components, the formula, recommended scales, and explicit caveats about when scores should and should not govern decisions.
3. RICE produces a continuous numeric score (Reach × Impact × Confidence) ÷ Effort, intended for sorting; the authors caution scores "shouldn't be used as a hard and fast rule" and recommend re-evaluating after sorting ("Are there projects where the score seems too high or too low?").
