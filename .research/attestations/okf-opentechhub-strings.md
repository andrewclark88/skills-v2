...
fetched: 2026-07-20
source_title: Google's Open Knowledge Format Comes With Strings
...
1. What began with who can open your [files]… what you can read… asking permission. That is what makes an open format worth having.
2. No new model, no software to install, no account. Just a convention: plain text files, a few labels at the top of each, and ordinary links between them. That is the whole idea.
