...
fetched: 2026-07-20
source_title: Google's Open Knowledge Format, and the Plugin I Built for It (ap7i)
...
1. I've converted several of my documentation repositories to OKF, adding just enough structure that an agent can read them without me re-explaining the layout every time.
